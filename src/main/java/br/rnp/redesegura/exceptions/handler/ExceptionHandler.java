package br.rnp.redesegura.exceptions.handler;

import br.rnp.redesegura.dtos.response.ErrorResponse;
import br.rnp.redesegura.dtos.response.ValidationErrorResponse;
import br.rnp.redesegura.exceptions.BadRequestException;
