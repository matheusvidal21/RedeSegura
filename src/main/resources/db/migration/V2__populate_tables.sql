...
VALUES
    ...
    ((SELECT id FROM vulnerabilities WHERE title = 'SMTP Open Relay' LIMIT 1), 'SMTP Open Relay', 'HIGH', 'OPEN', 'SMTP server is misconfigured as an open relay.', 'Initial discovery of vulnerability'),
